...
```
*/
import { hex as jettonWalletHex } from "./jetton-wallet.compiled.json";
export const jettonWalletCodeCell = Cell.fromBoc(
  Buffer.from(jettonWalletHex, "hex")
)[0];
...
let airdropData = Dictionary.loadDirect(
...
(async () => {
  wallet_code_raw = jettonWalletCodeCell;
})();
